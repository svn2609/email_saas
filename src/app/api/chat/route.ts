...
export async function POST(req: Request) {
    try {
        console.log('In /api/chat file, helllooooo')
        ...
        const response = await fetch(
            `${process.env.AI_SERVICE_URL}/ai/chat/context`,
            {
                method: 'POST',
                headers: {
        ...
        // Pass the ReadableStream directly to StreamingTextResponse
        ...
        // // @ts-ignore
        // return new StreamingTextResponse(resp.data);
